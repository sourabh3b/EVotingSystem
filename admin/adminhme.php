...
<head>
   ...
   a.two:link {color:#CCFFCC;}
   a.two:visited {color:#CCFFCC;}
...
$sql="SELECT * FROM admin";                 //making query for all the halls in the database
$abc=mysql_query($sql);

while($row=mysql_fetch_array($abc)){


$hal=$row['dbname'];              //assigning each halls database names to variables
...
<div class="ex">         <!-- Here you are printing those variables assigned in php-->
<h3><?php echo $name; ?></h3>


<h3 align="left">codename of hall=<?php echo $htmlname; ?></h3>

<h3 align="right">Nomination Id of hall=<?php echo $nomhall; ?></h3>

<h3 align="right">database name of hall=<?php echo $hal; ?></h3>
