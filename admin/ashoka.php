...
$sql="SELECT * FROM nom1 WHERE dep='gs'";      //selecting all who have nominated for gs
$abc=mysql_query($sql);
$gs_votes=array();                              //creating new array to store their votes
$gs_name=array();                                 //creating new array to store their names
$i=0;
while($row=mysql_fetch_array($abc))
{

$a=$row['vote'];                      //assigning results of query to anew variable
$b=$row['name'];                   
array_push($gs_votes,$a); //adding those variables into those array
...
$sql="SELECT * FROM nom1 WHERE dep='tech'"; //selecting all who have nominated for  tech
$abc=mysql_query($sql);
$tech_votes=array();
$tech_name=array();
$i=0;
...
$sql="SELECT * FROM nom1 WHERE dep='mess'";                ////selecting all who have nominated for mess
$abc=mysql_query($sql);
$mess_votes=array();
$mess_name=array();
$i=0;
...
$sql="SELECT * FROM nom1 WHERE dep='litrature'";               ////selecting all who have nominated for litrature
$abc=mysql_query($sql);
$lit_votes=array();
$lit_name=array();
$i=0;
...
$sql="SELECT * FROM nom1 WHERE dep='sports'";            //selecting all who have nominated for sports
$abc=mysql_query($sql);
$sports_votes=array();
$sports_name=array();
$i=0;
...
$sql="SELECT * FROM nom1 WHERE dep='cult'";                              //selecting all who have nominated for cult
$abc=mysql_query($sql);
$cult_votes=array();
$cult_name=array();
$i=0;
...
$sql="SELECT * FROM nom1 WHERE dep='main'";                           //selecting all who have nominated for maintainance
$abc=mysql_query($sql); 
$main_votes=array();
$main_name=array();
$i=0;
...
$sql="SELECT * FROM nom1 WHERE dep='heal'";          //selecting all who have nominated for health
$abc=mysql_query($sql);
$heal_votes=array();
$heal_name=array();
$i=0;
