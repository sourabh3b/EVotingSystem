...
<head>
	...
	<style type="text/css">                    <!--styling of body and navbar-->
	  body {
		padding-bottom: 40px;
	  }
	  .sidebar-nav {
	...
	<div class="container-fluid">
		...
		<div class="col-md-4">
			...
			<form action="" method="POST">
				...
				<?php           //using a dropdown to show all halls
				...
				<button type="submit" class="btn btn-danger form-control" name="delhall" >Delete Hostel!</button>
...
if(isset($_POST['hall'])){             //checking if user has submitted the form

$abc=$_POST['hall'];                 //assigning post variable for a variable



echo $abc;

$sql2="SELECT * FROM admin WHERE htmlname='$abc'";              //checking for a  hall in database,if exists delete that hall
$abc2=mysql_query($sql2);

while($row=mysql_fetch_assoc($abc2)){
...
mysql_query("DROP TABLE `$hallname`");
mysql_query("DROP TABLE `$nomhall`");
$sql="DELETE FROM admin WHERE htmlname='$abc'";
