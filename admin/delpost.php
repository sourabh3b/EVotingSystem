...
<head>
	...
	<meta name="author" content="Yashwanth">     <!--styling of body-->
...
<!-- topbar starts -->
	...
	<div class="container-fluid">
		...
		<div class="col-md-4">
				...
				<center><h1><b>Delete Department</b></h1>
			    <form action = "" method="POST">  <!--form for deleting the post-->
					<label>Department to Delete</label>
					<select name = "post" class = "form-control">
					<?php                 //using a dropdown to show all posts
					$getpost = mysql_query("SELECT * FROM post");
					while($droppost = mysql_fetch_assoc($getpost)){
					$value = $droppost['htmlpost'];
					...
					<button type="submit" class="btn btn-danger form-control" name="delpost" >Delete Post!</button>
				</form>
			</center>
...
if(isset($_POST['post'])){             //checking if user has submitted the form

$abc=$_POST['post'];       //assigning post variable for a variable



echo $abc;

$sql="DELETE FROM post WHERE htmlpost='$abc'";        //checking for a  post in database,if exists delete that post
