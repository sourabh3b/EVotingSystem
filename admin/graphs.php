...
$abc=$_POST['hall'];
echo $abc;
 $sql="SELECT * FROM `admin` WHERE `htmlname`='$abc'";
 $ab=mysql_query($sql);
//echo $ab;
...
<!-- topbar starts -->
	...
	<div class="container-fluid">
		...
		<div class="col-md-4">
				<center>
			<h2>Click on the Hall to view graphical statistics of those halls</h2>
			<h3><a href="aryabhatta.php">Aryabhatta hall</a></h3>
			<h3><a href="ashoka.php">Ashoka hall</a></h3>
            <h3><a href="chanakya.php">Chanakya hall</a></h3>			
            <h3><a href="buddha.php">Gautam Buddha hall</a></h3>	      
		  </center>
